...
<?php
//Connect to the database and displaying page 2 with 8 rows per page.
include "Database_Connection.php";

//Run Select statement
$prodDeal = "Special Item";
$sqlDeal = "SELECT Prod_Photo,Prod_Name,Prod_Price FROM product WHERE Prod_Type= ? ORDER BY Prod_Name ASC LIMIT 8 OFFSET 8";
