...
<!--Displaying product details from the database in page 2-->
<div id="display2">
<?php
...
$sqlBrowse = "SELECT Prod_Photo,Prod_Name,Prod_Price FROM product ORDER BY Prod_Name ASC LIMIT 8 OFFSET 8";
